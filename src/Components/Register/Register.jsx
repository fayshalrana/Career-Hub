...
const Register = () => {
  ...
  return (
   <>
     <div style={{ backgroundImage: "url(./banner2.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center", padding: '6rem 0 3rem', height: "100%" }} className="h-screen flex justify-center items-center">
        ...
        <form onSubmit={handleRegister} autoComplete="off">
            ...
            <div className="flex flex-col mb-2">
                <div className="flex relative ">
                    ...
                    <input type='password' className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Your password" name='password' required />
                </div>
            </div>
            <div className="flex flex-col mb-6">
                <div className="flex relative ">
                    ...
                    <input type='password'  className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Confirm password" name='confirmPassword' required />
                </div>
            </div>
            <div className="mb-3">
                <div className="relative inline-block w-10 mr-2 align-middle select-none">
                    <input type="checkbox" name="toggle" id="Orange" className="checked:bg-yellow-500 outline-none focus:outline-none right-4 checked:right-0 duration-200 ease-in absolute block w-6 h-6 rounded-full bg-black border-4 appearance-none cursor-pointer" />
